codeunit 50103 ImportContactFromEAPI
{
    trigger OnRun()
    begin
        ImportContactsFromErabliereAPI(false);
    end;
    ...
    local procedure SynErabliereAPIContact(var ContactRec: Record "Contact"; var ContactToken: JsonToken)
    begin
